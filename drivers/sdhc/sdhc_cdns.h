...
#define CDNS_RESP_R1B	SDHC_CDNS_XFER_MODE_RTS_MASK | \
			SDHC_CDNS_XFER_MODE_CRCCE |    \
			SDHC_CDNS_XFER_MODE_CICE

#define CDNS_RESP_R1	SDHC_CDNS_CMD_RESP_L48_MASK |  \
			SDHC_CDNS_XFER_MODE_CRCCE |    \
			SDHC_CDNS_XFER_MODE_CICE

#define CDNS_RESP_R2	SDHC_CDNS_CMD_RESP_L136_MASK | \
			SDHC_CDNS_XFER_MODE_CRCCE

#define CDNS_RESP_R3	SDHC_CDNS_CMD_RESP_L48_MASK

#define CDNS_RESP_R6	SDHC_CDNS_XFER_MODE_RTS_MASK | \
			SDHC_CDNS_XFER_MODE_CRCCE |    \
			SDHC_CDNS_XFER_MODE_CICE
 ...
 * two combined masks. Since SDHC_CDNS_INT_ENABLE and SDHC_CDNS_INT_SIGNAL_ENABLE
 * reuse the same bit positions as SDHC_CDNS_INT_STATUS, these two masks are
...
#define SDHC_CDNS_NORMAL_INT_MASK                                                                    \
	(SDHC_CDNS_INT_ENABLE_CINT_SE | SDHC_CDNS_INT_ENABLE_CR_SE | SDHC_CDNS_INT_ENABLE_CIN_SE |   \
	 SDHC_CDNS_INT_ENABLE_BWR_SE | SDHC_CDNS_INT_ENABLE_BRR_SE | SDHC_CDNS_INT_ENABLE_DMAINT_SE |\
	 SDHC_CDNS_INT_ENABLE_BGE_SE | SDHC_CDNS_INT_ENABLE_TC_SE | SDHC_CDNS_INT_ENABLE_CC_SE)

#define SDHC_CDNS_ERR_INT_MASK                                                                       \
	(SDHC_CDNS_INT_ENABLE_ERSP_SE | SDHC_CDNS_INT_ENABLE_EADMA_SE | SDHC_CDNS_INT_ENABLE_EAC_SE |\
	 SDHC_CDNS_INT_ENABLE_ECL_SE | SDHC_CDNS_INT_ENABLE_EDEB_SE | SDHC_CDNS_INT_ENABLE_EDCRC_SE |\
	 SDHC_CDNS_INT_ENABLE_EDT_SE | SDHC_CDNS_INT_ENABLE_ECI_SE | SDHC_CDNS_INT_ENABLE_ECEB_SE |  \
	 SDHC_CDNS_INT_ENABLE_ECCRC_SE | SDHC_CDNS_INT_ENABLE_ECT_SE)

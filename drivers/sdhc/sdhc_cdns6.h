...
#define COMBOPHY_DLL_SLAVE_CTRL_REG_READ_DQS_CMD_DELAY GENMASK(31, 24)
#define COMBOPHY_DLL_SLAVE_CTRL_REG_READ_DQS_DELAY     GENMASK(7, 0)
...
#define SDHC_CDNS6_PHY_CTRL_CFGS_INIT                                                              \
	.sd_ds_phy_cfg = {0x00380004, 0x01A00040, 0x00000000, 0x00000001, 0x00800004},             \
	.sd_hs_phy_cfg = {0x00380004, 0x01A00040, 0x00000000, 0x00000001, 0x00800004},             \
...
#define QUIRK_CDNS6_SDHC_DEFINE(n)                                                                 \
	static const struct sdhc_cdns6_data sdhc_cdns_quirk_data_##n;                              \
	                                                                                           \
...
DT_INST_FOREACH_STATUS_OKAY(QUIRK_CDNS6_SDHC_DEFINE)

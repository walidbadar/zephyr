...
#ifndef __ZEPHYR_DRIVERS_SDHC_SDHCI_HW_H_
#define __ZEPHYR_DRIVERS_SDHC_SDHCI_HW_H_
 ...
 * two combined masks. Since SDHCI_INT_ENABLE and SDHCI_INT_SIGNAL_ENABLE
 * reuse the same bit positions as SDHCI_INT_STATUS, these two masks are
 * valid against all three registers.
 */
#define SDHCI_NORMAL_INTERRUPT_MASK                                                                \
	(SDHCI_INT_ENABLE_CINT_SE | SDHCI_INT_ENABLE_CR_SE | SDHCI_INT_ENABLE_CIN_SE |             \
	 SDHCI_INT_ENABLE_BWR_SE | SDHCI_INT_ENABLE_BRR_SE | SDHCI_INT_ENABLE_DMAINT_SE |          \
	 SDHCI_INT_ENABLE_BGE_SE | SDHCI_INT_ENABLE_TC_SE | SDHCI_INT_ENABLE_CC_SE)

#define SDHCI_ERROR_INTERRUPT_MASK                                                                 \
	(SDHCI_INT_ENABLE_ERSP_SE | SDHCI_INT_ENABLE_EADMA_SE | SDHCI_INT_ENABLE_EAC_SE |          \
	 SDHCI_INT_ENABLE_ECL_SE | SDHCI_INT_ENABLE_EDEB_SE | SDHCI_INT_ENABLE_EDCRC_SE |          \
	 SDHCI_INT_ENABLE_EDT_SE | SDHCI_INT_ENABLE_ECI_SE | SDHCI_INT_ENABLE_ECEB_SE |            \
	 SDHCI_INT_ENABLE_ECCRC_SE | SDHCI_INT_ENABLE_ECT_SE)

/*
 * Bus-voltage-select encodings used by SDHCI_HOST_CTRL_BVS_MASK.
 * These match the SDHCI specification (also identical to the values the
 * previous SDHCI_HOST_VOL_*_V_SELECT constants encoded).
 */
#define SDHCI_HOST_VOL_3_3_V_SELECT 0x7u
#define SDHCI_HOST_VOL_3_0_V_SELECT 0x6u
#define SDHCI_HOST_VOL_1_8_V_SELECT 0x5u
...
#endif /* __ZEPHYR_DRIVERS_SDHC_SDHCI_HW_H_ */
